...
const DICTIONARY = {
  en: {
    ...
    heroSubtitle:
      "Daily GM check-ins on Ink. Mint the NFT for 0.002 ETH to unlock Daily reposts.",
    gmTodayLabel: "GM today",
    gmTotalLabel: "Total GM",
    postsTotalLabel: "Total posts",
    walletLabel: "Wallet",
    gmPanelTitle: "GM Check-in",
    gmPanelText:
      "No NFT needed to say GM. One GM per day per wallet or device.",
    mintPanelTitle: "Ink Mint — 0.002 ETH",
    mintPanelText:
      "Mint the GM NFT on Ink L2. Immutable, ownerless contract. Max 5,000 supply, 1 per wallet.",
    ...
    gmStatusConnect: "Connect wallet",
    toastGmAlready: "GM already recorded today",
    toastGmRecorded: "GM recorded",
    toastGmNotConfigured: "GM contract not configured",
    toastGmFailed: "GM transaction failed",
    toastGmConnect: "Connect wallet to GM",
    toastGmContractMissing: "GM contract not found on Ink",
    ...
    toastSignatureRejected: "Signature rejected",
    toastDailyLoading: "Loading daily post...",
    toastDailyError: "Daily not available",
    dailyContentTitle: "Daily post",
    dailyCopy: "Copy",
    dailyShare: "Share on X",
    dailyEmpty: "No posts available yet",
    dailyStatusUnlocked: "Unlocked",
    dailyStatusLocked: "Locked",
    toastDailyCopied: "Copied to clipboard",
    toastSupabaseMissing: "Supabase is not configured",
    toastGmRequired: "Press GM first",
    toastDailyUsed: "Daily already used today",
    dailyStatusReady: "Ready",
    dailyStatusGmRequired: "GM first",
    dailyStatusDone: "Done today",
    dailyStatusConnect: "Connect wallet",
  },
  ru: {
    heroEyebrow: "Тапни GM в сети Ink L2",
    heroTitle: "GM. Mint. Share.",
    heroSubtitle:
      "Ежедневные GM в Ink. Минт NFT за 0.002 ETH открывает Daily репосты.",
    gmTodayLabel: "GM сегодня",
    gmTotalLabel: "Всего GM",
    postsTotalLabel: "Всего постов",
    walletLabel: "Кошелек",
    ...
    mintPanelTitle: "Ink Mint — 0.002 ETH",
    mintPanelText:
      "Минти GM NFT в Ink L2. Контракт неизменяемый и без владельца. Максимум 5,000, 1 на кошелек.",
    ...
    gmStatusConnect: "Подключи кошелек",
    toastGmAlready: "GM уже отмечен сегодня",
    toastGmRecorded: "GM записан",
    toastGmNotConfigured: "GM контракт не настроен",
    toastGmFailed: "GM транзакция не прошла",
    toastGmConnect: "Подключи кошелек для GM",
    toastGmContractMissing: "GM контракт не найден в Ink",
    ...
    toastSignatureRejected: "Подпись отклонена",
    toastDailyLoading: "Загружаю Daily пост...",
    toastDailyError: "Daily недоступен",
    dailyContentTitle: "Daily пост",
    dailyCopy: "Копировать",
    dailyShare: "Поделиться в X",
    dailyEmpty: "Пока нет готовых постов",
    dailyStatusUnlocked: "Открыто",
    dailyStatusLocked: "Закрыто",
    toastDailyCopied: "Скопировано",
    toastSupabaseMissing: "Supabase не настроен",
    toastGmRequired: "Сначала нажми GM",
    toastDailyUsed: "Сегодня уже использовано",
    dailyStatusReady: "Готово",
    dailyStatusGmRequired: "Сначала GM",
    dailyStatusDone: "Готово сегодня",
    dailyStatusConnect: "Подключи кошелек",
  },
};
