...
const DICTIONARY = {
  en: {
    ...
    mintPanelText:
      "Mint the GM NFT on Ink L2. Immutable, ownerless contract. Max 5,000 supply, 1 per wallet. Rewards go to 0x2059...b63F.",
  ...
  ru: {
    ...
    mintPanelTitle: "Ink Mint — 0.002 ETH",
    mintPanelText:
      "Минти GM NFT в Ink L2. Контракт неизменяемый и без владельца. Максимум 5,000, 1 на кошелек. Награды: 0x2059...b63F.",
